...
class DinoVisionTransformer(nn.Module):
    def __init__(
        ...
        # self.head = nn.Linear(embed_dim, num_classes)   # 替换 Identity
        ...
        # self.head = nn.Linear(embed_dim, 2)   # 替换 Identity
    ...
    def forward(
        ...
        **kwargs
        ...
        if is_training:
            ...
            out =  self.head(ret["x_norm_clstoken"])
        # out1 =  ret["x_norm_clstoken"]
        # print(out1.shape)
        return out
